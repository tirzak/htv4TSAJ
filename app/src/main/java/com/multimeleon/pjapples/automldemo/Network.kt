    ...
    init {
        ...
        val headerAuthorizationInterceptor = Interceptor() {
            ...
            val headers = request.headers().newBuilder().add(
                "Authorization",
                "Bearer ya29.c.Kmm9B_2cZeHouaAQfOf3uB6RYRmxlkVxvk_488KhdEjfJLv9sI-t-aQSSrp4a0H4Tq_9piwrNZbUIonXk3lJLIfwKocCz93ACQCexGVK0JsbPk\n" +
                        "1mLeLc5afrHhbacv_mifetxluRmtlzR_4"
            ).build()
...
internal interface Endpoint {
    ...
    @POST("projects/357086778384/locations/us-central1/models/ICN7988589692536750080:predict")
